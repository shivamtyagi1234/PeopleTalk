						...
						<div class="container">
							<form action="" data-toggle="validator" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-lg-5">
										<input type="email" name='email'class="form-control" id="email" placeholder="Enter your email" value="xyz@gmail.com" required/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
									<label for="phone" class="col-lg-2 control-label">Phone:</label>
									<div class="col-lg-5">
										<input type="text" name='phone' class="form-control" pattern="^[_0-9]{1,}$" maxlength="10" minlength="10" id="phone" placeholder="Enter your phone" value="9874561230" required/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
									<label for="name" class="col-lg-2 control-label">Name:</label>
									<div class="col-lg-5">
										<input type="text" class="form-control" id="name" name="name" pattern="^[_A-Z a-z]{1,}$"  placeholder="Enter your name" value="XYZ" required/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<input type="text" name="dob" class="form-control" id="dob" value="2017-03-21"/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
